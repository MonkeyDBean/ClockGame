...
var MapLevel = (function (_super) {
    ...
    MapLevel.prototype.init = function () {
        this.bigTime = 0;
        this.slowTime = 0;
        this.quickTime = 0;
        this.wallTime = 0;
    ...
    MapLevel.prototype.collisionFrameHandler = function () {
    ...
    MapLevel.prototype.readMap = function () {
    ...
    MapLevel.prototype.removeCollisionFrame = function () {
        this.removeEventListener(egret.Event.ENTER_FRAME, this.collisionFrameHandler, this);
    };
    MapLevel.prototype.hitTest = function (obj1, obj2) {
