var audio = {
	...
	compatibility: {},
	convolver: {},
	files: ["./webaudio/audio_start.mp3", "./webaudio/audio_failure.mp3", "./webaudio/audio_victory.mp3", "./webaudio/audio_launch.mp3", "./webaudio/audio_done.mp3","./webaudio/audio_slow.mp3","./webaudio/audio_quick.mp3", "./webaudio/audio_wall.mp3","./webaudio/audio_block.mp3","./webaudio/audio_big.mp3","./webaudio/audio_startButton.mp3"],
	gain: {},
	gain_loop: {},
	gain_once: {},
	pause_vis: true,
...
audio.SupportAudio = function()
{
	return audio.isSupport;
};
