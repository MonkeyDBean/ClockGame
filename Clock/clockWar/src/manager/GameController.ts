...
class GameController
{
    ...
    public _stageJson:any;//场景Json数据

    public curLevel:number;//当前关卡,用于读取地图

    public maxLevel:number;//关卡数量

    public mapLevel:MapLevel;//当前地图
    public smallBall:SmallBall;//小球

    public myScore:number;//获得分数

    public myLife:number;//玩家生命

    public gameMode:number;//游戏模式，1为关卡模式,2为生存模式
    ...
    public touchMove:boolean;//触屏使指针开始移动
