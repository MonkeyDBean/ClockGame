...
var GameController = (function () {
    ...
    p.IconEventEnd = function () {
        ...
        //GameView.m_UI.weixin_Icon.visible = true;
        //GameView.m_UI.weixin_Icon.addEventListener(egret.TouchEvent.TOUCH_TAP,this.shareWechat,this);
    };
    //开始界面，顶层图标移除以及取消监听
    p.IconEventStart = function () {
        this.containerText = "MonkeyBean Game : 时钟的空间,你能得几分？ ";
        ...
        //GameView.m_UI.weixin_Icon.visible = false;
        //GameView.m_UI.weixin_Icon.removeEventListener(egret.TouchEvent.TOUCH_TAP,this.shareWechat,this);
    };
    //重新开始
    p.restartEvent = function () {
        this.IconEventStart();
        ...
        //    this.StartGameSurvival();
        //}
        ////发射小球为touchBegin，再来一次为touchTap,如果设为相同，则采用如下延迟1ms的方式执行重新开始
        //egret.setTimeout(function():void{
        //    this.StartGame();
        //},this,1);
    };
    //触屏逻辑
    p.touchEvent = function () {
    ...
    //author新浪主页链接跳转
    p.hrefEvent = function () {
        //进入author新浪微博主页
        window.open(this.authorHref, 'newwindow');
    };
    //分享到新浪微博
    p.shareXinlang = function () {
    ...
    p.Calculation = function () {
        //TODO 计算得分
        //console.log(this.data.originalScore);
